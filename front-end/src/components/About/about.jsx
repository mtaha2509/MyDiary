...
const About = () => {
  ...
  useEffect(() => {
    ...
    const map = L.map(mapRef.current).setView(
      [31.48171749391388, 74.30306823824712],
      13
  ...
  return (
    <div>
      ...
      <div className="about-container">
        <div className="about-section">
          <div className="dropdown">
            <h1 className="dropbtn" style={{ textAlign: "center" }}>
              About Us
            </h1>
            <div className="dropdown-content">
              <p style={{ fontSize: "medium" }}>
                Welcome to MyDiary, your trusted companion for capturing and
                cherishing your life's moments. Our platform is designed to
                provide you with a seamless and secure way to document your
          ...
          <div className="dropdown">
            ...
            <div className="dropdown-content">
              <p style={{ fontSize: "medium" }}>
                ...
                creating a user-friendly and reliable journaling platform. Our
                team consists of developers, designers, and customer support
                specialists who work tirelessly to ensure that your experience
                with MyDiary is exceptional. <br />
                <br />
                <br />
                <span style={{ fontWeight: "Bold" }}>
                  Meet the faces behind MyDiary:
                </span>
              </p>
              ...
              <div className="team-members">
                <div className="member">
                  <div className="image-container">
                    <img
                      src={hassaan}
                      alt="Syed Muhammad Hassaan Ali"
                      style={{ width: "70%", height: "15%" }}
                    />
                    <div className="description">
                      Syed Muhammad Hassaan Ali - Developer
                    </div>
                  </div>
      ...
      <div className="fadeIn about-footer">
        <Footer />
      </div>
    </div>
  );
